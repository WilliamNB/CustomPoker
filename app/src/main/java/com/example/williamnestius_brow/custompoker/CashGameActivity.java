...
public class CashGameActivity extends AppCompatActivity {

    int maxBuyIn, minBuyIn, bigBlindValue, smallBlindValue, minBet, smallBlindP, bigBlindP, activeP;
    int playersInGame;
    private FirebaseDatabase database;
    private DatabaseReference myRefG, myRefR, myRefU;
    private String gameID, ruleID, playerID, uid;
    private boolean isHost, sDone, bDone, runOnce, foldOnce, start;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maxBuyIn = startIntent.getIntExtra("MaxBuyIn", maxBuyIn);
        minBuyIn = startIntent.getIntExtra("MinBuyIn", minBuyIn);
        ...
        table = new TableHand();
        Log.d("firstToShow", "max" + maxBuyIn);
        Log.d("firstToShow", "min" + minBuyIn);
        Log.d("firstToShow", "big" + bigBlindValue);
